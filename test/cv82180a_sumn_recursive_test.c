/**
 * @file cv82180a_sumn_recursive_test.c
 * @brief SUMN verified against the real HP-41CV+82180A architecture -
 * see sumn_recursive_test.c (the CX version) for the full rationale.
 *
 * The real showcase: a genuinely SELF-recursive FOCAL program
